...
- **v1 (Current stable):** Supported for bug fixes. [View Documentation](./README.md)
- **v2 (Latest):** Recommended for new projects. Includes a new API. [View v2 Documentation](./v2/README.md)
